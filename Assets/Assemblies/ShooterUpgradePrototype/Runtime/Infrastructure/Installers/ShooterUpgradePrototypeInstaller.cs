...
namespace ShooterUpgradePrototype.Infrastructure.Installers
{
    public sealed class ShooterUpgradePrototypeInstaller : MonoInstaller
    {
        ...
        [SerializeField] private StatCollection _playerStatsCollection;

        public override void InstallBindings()
        {
            if (_playerStatsConfig != null && _playerStatsCollection != null &&
                _playerStatsConfig.Stats.Collection != _playerStatsCollection)
            {
                _playerStatsConfig.Stats.Collection = _playerStatsCollection;
            }
